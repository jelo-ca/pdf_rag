...
def run_example_queries(rag):
    """Run example queries against the indexed documents."""
    print("\n5. Example Queries:")
    print("-" * 70)
...
def main():
    """
    Demonstrate multi-file RAG pipeline functionality.

    Loads multiple PDF files, builds a unified index with document classification,
    and runs example queries across all indexed documents.
    """
    print("=" * 70)
    ...
    rag = RAGPipeline(persist_dir="./storage", n_gpu_layers=-1)
